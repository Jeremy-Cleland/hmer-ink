...
def evaluate(model_path: str, 
    ...
    if output_path:
        ...
        for file_id, pred, target in zip(all_file_ids, all_predictions, all_targets):
            ...
            edit_distance = compute_metrics([pred], [target], metrics=['edit_distance'])['edit_distance']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--beam_size", type=int, default=4, help="Beam size for generation")
